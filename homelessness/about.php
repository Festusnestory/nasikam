            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
              <div class="card">
                <div class="card-body">
                  <center class="mt-4">
                    <img
                      src="assets/img/205-2054169_support-icon-png-for-kids-can-i-help.png"
                      class="rounded-circle"
                      width="150"
                    />
                    <h4 class="card-title mt-2">How can we help?</h4>
                    <h13 class="card-subtitle">App Version 3.0.20.Beta</h13><br>
                ...
                <div class="card-body">
                <small class="text-muted"><h6>This App was co-designed with the Youth in Walvis Bay, aimed sensitize the community towards the homeless living within Walvis Bay area.</h6></small>
                 
                  <br>
                </button>
            <i class="mdi-gmai3l"></i>
                 
                  </button>
                  <small class="text-muted">Email address </small>
                  <h6>homelessApp@gmail.com</h6>
                 
                  <i class="icon-location-pin3"></i>
                 <small class="text-muted pt-4 db">Phone</small>
                  <h6>+264 81 388 5625</h6>
    </div>
 
    <small class="text-muted"><h6>MADE POSSIBLE BY:</h6></small>
    <div
            class="user-profile position-relative"
            style="
              background: url(./assets/img/UNDP.png )
                no-repeat; 
                height: 550px;
                width: 230px;
                float:left;
          ...
          <div
            ...
            style="
              background: url(./assets/img/MinistryofHealth.png )
                no-repeat; 
                height: 250px;
                width: 230px;
