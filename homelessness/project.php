              ...
              <form>
                <div class="modal-header d-flex align-items-center" style = "width:500px; background-color:aliceblue">
                  <h5 class="modal-title" id="createModalLabel">
                    <i class="ti-marker-alt me-2"></i> Add Project
                  </h5>
                  <button
                    type="button"
                    class="btn-close"
                        ...
                        <div class="col-md-6">
                          <div class="form-floating mb-3">
                            <input name="gender" value=""
                              ...
                              id="gender"
                            />
							<label for="gender">Cellphone:</label>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class=" form-floating mb-3">
                            <input name="ethnic" value=""
                              ...
                              id="ethnic"
                            />
							<label for="ethnic">Address:</label>
                          </div>
                        </div>
                        </div>
						 <div class="row">
            ...
            <div class="col-12">
                ...
                <thead class="table-light">
                  <tr>
                    ...
                    <th class="border-bottom border-top">Erf no.</th>
				...
				<?php
								...
								foreach($allorderlist as $index => $order)
								{
									...
									echo "<td>$erf_no</td>";
									echo "<td>$email</td>";
                                    echo "<td><a href='?id=$id'>view</a></td>";
									echo  "</tr>";
								}
