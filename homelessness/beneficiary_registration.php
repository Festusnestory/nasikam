...
if (isset($_GET['id'])){
	$id = $_GET['id'];
              ...
              $order = new order();
              $allorderlist = $order->selectAll(); //working
              //$allorderlist = $order->selectAllwhere();


              //This is the condition
              $condition = "order_id='$id'";
              //Here we are selecting all where the id is equal to $id
              $allorderlist = $order->selectAllWhereG($condition);
              //echo "<script>console.log('Debug Objects: " . $allorderlist . "' );</script>";
		  ...
		  <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <form class="form-horizontal" action ="task_process.php" method = "post">
                  ...
                  <div class="card-body">
                    ...
                    <div class="mb-3 row">
                      <label
                        for="email20"
                        class="col-sm-3 text-end control-label col-form-label"
                        >Do you have national identity Card?</label
                      >
                      <div class="col-sm-6">
                    ...
                    <div class="mb-3 row">
                      <label
                        for="cono3"
                        class="col-sm-3 text-end control-label col-form-label"
                        >What is your national Identity ID number?</label
                      >
                      <div class="col-sm-6">
					 ...
					 <div class="mb-3 row">
                      <label
                        for="cono3"
                        class="col-sm-3 text-end control-label col-form-label"
                        >Where do you usually reside? Most of the time,where can you be found?</label
                      >
                      <div class="col-sm-6">
                        <input   type="text" name = "cellphone"value=""
                          class="form-control"
					 ...
					 <div class="mb-3 row">
                      <label
                        for="cono3"
                        class="col-sm-3 text-end control-label col-form-label"
                        >What is your phone number if you have one?</label
                      >
                      <div class="col-sm-6">
                        <input   type="text" name = "cellphone"value=""
                          class="form-control"
					 ...
					 <div class="mb-3 row">
                      <label
                        for="cono3"
                        class="col-sm-3 text-end control-label col-form-label"
                        >Do you have an alternate phone number? Maybe a friend or family member?</label
                      >
                      <div class="col-sm-6">
                        <input   type="text" name = "cellphone"value=""
                          class="form-control"
					 ...
					 <div class="mb-3 row">
                      <label
                        for="cono3"
                        class="col-sm-3 text-end control-label col-form-label"
                        >Kindly tell me, when did you first become homeless?</label
                      >
                      <div class="col-sm-6">
                        <input   type="text" name = "cellphone"value=""
                          class="form-control"
					...
					<div class="mb-3 row">
                      <label
                        for="property_type"
                        class="col-sm-3 text-end control-label col-form-label"
                        >What is your current living situation?</label
                      >
                      <div class="col-sm-6">
					...
					<div class="mb-3 row">
                      <label
                        for="property_type"
                        class="col-sm-3 text-end control-label col-form-label"
                        >What service are you most in need of?</label
                      >
                      <div class="col-sm-6">
                        <select name="property_type" class="form-select" id="property_type" required>
							<option></option>
