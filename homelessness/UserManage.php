            ...
            <div class="card card-success">
              <div class="card-header border-0">
                   <div class="row">
                    ...
                    <div style="background-color:#45b3f7" class="btn btn-success btn-md"><h5 class="card-title"><b>Manage Info</b></h5></div>
                       <div class="col-md-5"></div>
                  </div>
              </div>
              <!-- /.card-header -->
            ...
            <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">
                        <button type="button" style="background-color:light-blue"   data-toggle="modal" data-target=""><i class="fa fa-plus"><a href="login.php"> Add Manage</a></i>
                        </button>
                    </h3>
                  </div>
      <!-- /.card-header -->
          <div class="card-body">
            <table id="example2" class="table table-bordered table-striped table-hover" cellspacing="0" width="100%">
				  ...
				  <?php
								...
								$login = new login();
								$allorderlist = $login->selectAll();
								foreach($allorderlist as $index => $login)
								{
