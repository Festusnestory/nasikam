                ...
                <div class="card-body">
                  <center class="mt-4">
                    <img
                      ...
                      width="150"
                    />
                    <h4 class="card-title mt-2"  style = "font-size:30px;">All the Legal Information </h4>
                    <h13 class="card-subtitle">Knowledge is power read up and know your rights </h13><br>
