              ...
              <form>
                <div class="modal-header d-flex align-items-center" style = "width:500px; background-color:aliceblue">
                  <h5 class="modal-title" id="createModalLabel">
                    <i class="ti-marker-alt me-2"></i> Add Beneficiary
                  </h5>
                  <button
                    type="button"
                    class="btn-close"
				...
				<form class="form-horizontal" action ="task_process.php" method = "post" style = "margin:0px;">
                  ...
                  <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-floating mb-3">
                            <input name="alternate" value=""
                              type="text"
                              class="form-control"
                              id="alternate"
                            />
							<label for="property_address">Alternate Contact</label>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class=" form-floating mb-3">
                            <input name="homeless_date" value=""
                              type="text"
                              class="form-control"
                              id="homeless_date"
                            />
							<label for="firstName1">Homelessness Date:</label>
                          </div>
                        </div>
                        </div>
						<div class="row">
                        <div class="col-md-6">
                          <div class="form-floating mb-3">
                           <select name="stuation" class="form-select" id="stuation" required>
							<option></option>
            ...
            <div class="col-12">
                ...
                <thead class="table-light">
                  <tr>
                    ...
                    <th class="border-bottom border-top">Surname</th>
                    <th class="border-bottom border-top">Gender:</th>
                    <th class="border-bottom border-top">Ethnicity</th>
                    <th class="border-bottom border-top">date of Birth</th>
                    <th class="border-bottom border-top">Id no.</th>
                    <th class="border-bottom border-top">Location</th>
                    <th class="border-bottom border-top">cellphone</th>
                    <th class="border-bottom border-top">Alternate no.</th>
                    <th class="border-bottom border-top">Homelessness date</th>
                    <th class="border-bottom border-top">current stuation</th>
                    <th class="border-bottom border-top">service need</th>
                    <th class="border-bottom border-top">Date created</th>
                    <th class="border-bottom border-top">Created by</th>
				...
				<?php
								...
								foreach($allorderlist as $index => $order)
								{
									...
									$valuation_purpose = $order->valuation_purpose;
