...
function MinimizeMenuDelay()
{
	setTimeout(MinimizeMenu, 100);
}
...
const LOADER_2_5 = '<div class="spinner-border text-primary" style="width: 2.5rem; height: 2.5rem" role="status"><span class="sr-only">Loading...</span></div>';