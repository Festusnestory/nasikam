        ...
        <div class="row page-titles">
          <div class="col-md-5 col-12 align-self-center">
            ...
            <ol class="breadcrumb mb-0">
              ...
              <li class="breadcrumb-item active"> Healthcare Worker</li>
            </ol>
          </div>
        </div>
        <!-- ============================================================== -->
              ...
              <form>
                <div class="modal-header d-flex align-items-center" style = "width:500px; background-color:aliceblue">
                  <h5 class="modal-title" id="createModalLabel">
                    <i class="ti-marker-alt me-2"></i> Add Healthcare worker
                  </h5>
                  <button
                    type="button"
                    class="btn-close"
				...
				<div class="card-body border-bottom" style = "width:">
                  <h4 class="card-title">Registration of Healthcare worker </h4>
				...
				<form class="form-horizontal" action ="task_process.php" method = "post" style = "margin:0px;">
                  ...
                  <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class=" form-floating mb-3">
                            <input name="administrator" value=""
                              type="text"
                              class="form-control"
                              id="administrator"
                            />
							<label for="ethnic">administrator</label>
                          </div>
                        </div>
                        </div>
        ...
        <div  class="row">
            <div class="col-12">
                ...
                <thead class="table-light">
                  <tr>
                    <th class="border-bottom border-top">Username</th>
                    <th class="border-bottom border-top">Name</th>
                    <th class="border-bottom border-top">email address:</th>
                    <th class="border-bottom border-top">administrator</th>
