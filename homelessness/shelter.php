              ...
              <form>
                <div class="modal-header d-flex align-items-center" style = "width:500px; background-color:aliceblue">
                  <h5 class="modal-title" id="createModalLabel">
                    <i class="ti-marker-alt me-2"></i> Add Shelter
                  </h5>
                  <button
                    type="button"
                    class="btn-close"
                        ...
                        <div class="col-md-6">
                          <div class=" form-floating mb-3">
                            <input name="surname" value=""
                              ...
                              id="surname"
                            />
							<label for="firstName1">Type of Shelter:</label>
                          </div>
                        </div>
                        </div>
						 <div class="row">
            ...
            <div class="col-12">
                ...
                <thead class="table-light">
                  <tr>
                    ...
                    <th class="border-bottom border-top">Type of Shelter</th>
                    <th class="border-bottom border-top">Town</th>
                    <th class="border-bottom border-top">Suburb</th>
                    <th class="border-bottom border-top">Cell</th>
				...
				<?php
								...
								foreach($allorderlist as $index => $order)
								{
                                    ...
                                    echo "<td><a href='?id=$id'>Remove</a> || <a href='?id=$id'>Edit</a></td>";
									echo  "</tr>";
								}
