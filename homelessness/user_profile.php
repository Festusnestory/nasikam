...
.btn:not(:disabled):not(.disabled) {
  ...
  <body>
	...
	<ins class="adsbygoogle"
		 style="display:block"
		 data-ad-client="ca-pub-6515133971086649"
		 data-ad-slot="7739571607"
		 data-ad-format="auto"
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
              <div class="card">
                <div class="card-body">
                  <center class="mt-4">
                    <img
                      src="assets/img/d4.jpg"
                      class="rounded-circle"
                      width="150"
                    />
                    <h4 class="card-title mt-2">Hanna Gover, 26</h4>
                    <h12 class="card-subtitle">Male</h12><br>
                    <h13 class="card-subtitle">Windhoek, Khomas Region, Namibia</h13>
                ...
                <div class="card-body">
                  ...
                  <div class="map-box">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3684.4917583443153!2d17.07573081401841!3d-22.56070388518889!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1c0b1b42a3fbcfe1%3A0x4c0378bfe8bf1a57!2sNational%20Software%20Engineering%20Academy!5e0!3m2!1sen!2sin!4v1639992925857!5m2!1sen!2sin" 
                      width="100%"
                      height="150"
                      frameborder="0"
                      style="border: 0"
				  ...
				  <!-- Step 1 -->
					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-bs-toggle="tab" href="#site_transact" role="tab">
								<span>Transact</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-bs-toggle="tab" href="#site_histry" role="tab">
								<span>Transaction Histry</span>
							</a>
						</li><li class="nav-item">
							<a class="nav-link" data-bs-toggle="tab" href="#site_medical" role="tab">
								<span>Medical</span>
							</a>
						</li><li class="nav-item">
							<a class="nav-link" data-bs-toggle="tab" href="#site_about" role="tab">
								<span>Where About</span>
							</a>
						</li>
					</ul>
					<!-- Tab panes-->
					<div class="tab-content">
						<div class="tab-pane active" id="site_transact" role="tabpanel">
							<div class="p-3">
								<h2>Transaction</h2>
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
              <div class="card">
                ...
                <div class="card-body">
                   ...
                   <div class="mb-3 row">
				   <small class="text-muted">PROJECTS </small><br/><br/>
                      <label
                        for="town"
                  ...
                  <br/><br/><br/>
                  <small class="text-muted pt-4 db">CLAIMS AND BENEFITS</small> <br/><br/><br/><br/>
                  <small class="text-muted pt-4 db">HEALTH CARE</small>
                  <span ><input type="checkbox" style = "margin-left:300px" checked="checked"></span>
                
                  <br/>
                  <br/>
                  <br/>
                 <small class="text-muted pt-4 db">FOOD</small>
                  <input type="checkbox" style = "margin-left:350px" checked="checked">
                 <br/><br/><br/>
                 <small class="text-muted pt-4 db">ACCOMONDATION</small>
                  <input type="checkbox" style = "margin-left:390px" checked="checked">
						...
						<div class="tab-pane  p-3" id="site_histry" role="tabpanel">
							
						</div><div class="tab-pane  p-3" id="site_medical" role="tabpanel">
							
						</div><div class="tab-pane  p-3" id="site_about" role="tabpanel">
