            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
              <div class="card">
                <div class="card-body">
                  <center class="mt-4">
                    <img
                      src="assets/img/feedbox.jpg"
                      class="rounded-circle"
                      width="159"
                    />
                    <h4 class="card-title mt-2" style = "font-size:30px;">We valued your feedback...</h4>
                    <h13 class="card-subtitle">This feature uses whatsapp</h13><br>
                ...
                <h4 class="card-title mt-2"  style = "text-align:center; "style = "font-size:50px;">Our Mobile App is still under development and we have come a long way, 
            but the future looks bright... </h4>
             
            
            <div class="container">
  <form action="action_page.php">
            <label for="subject"></label>
    <textarea id="subject" name="subject" placeholder="Enter your feedback..." style="height:200px"></textarea>
